...
public class JoinWeightWatcherDriverPage extends DriverBasePage {

	private FindAMeetingDriverPage findAMeetingPage = new FindAMeetingDriverPage(driver);
	...
	public JoinWeightWatcherDriverPage(WebDriver driver) {
		super(driver);
	...
	public JoinWeightWatcherDriverPage clickOnFirstResultAndVerifyName(){
		...
		Assert.assertTrue(cname.equalsIgnoreCase(locationinJoinPg));
